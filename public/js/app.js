...
var renderDropdownModified = function renderDropdownModified(data, val) {
  var _this = this;
...
var autoCompleteInstace = M.Autocomplete.init(searchInput, {
  data: {},
  limit: 15,
  sortFunction: false,
  onAutocomplete: function onAutocomplete(name) {
    var fullData = autoCompleteInstace.options.data[Symbol.for('FULLDATA')];
    var items = fullData.filter(function (item) {
...
searchInput.addEventListener('input', debounced(300, function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            data = suggestions.data.reduce(function (obj, sug) {
              return obj[sug.name] = sug.image, obj;
            } // comma operator
            , {});
