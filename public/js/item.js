...
var fetchExistences = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee() {
    var itemCode, res, data, existence, $exMsg, num, handleError;
    return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            handleError = function handleError() {
              var $exErrorMsg = document.getElementById('existence-error-msg');
              $exErrorMsg.textContent = 'Error al consultar existencias.';

              document.querySelector('.existences-error').classList.add('show');
            };

            itemCode = document.getElementById('item-code').textContent;
            _context.prev = 2;
            _context.next = 5;
            return fetch('/api/existences/' + itemCode);
          ...
          case 8:
            ...
            return _context.abrupt('return', handleError());

          case 12:
            existence = data.Existencia;
            $exMsg = document.getElementById('existence-msg');
            num = String(Number(existence.Stok));
  ...
  return function fetchExistences() {
...
var sliders = M.Slider.init(sliderElem, sliderOpts);
...
window.addEventListener('resize', function (event) {
  ...
  timeout = window.requestAnimationFrame(function () {
    var height = sliderResponsiveHeight();

    // If we are not going to change anything abort
    if (height === sliders[0].options.height) return;
    ...
    sliders = M.Slider.init(sliderElem, _extends({}, sliderOpts, { height: height }));
  });
}, false);
